...
3. If scanning starts too early, the last line would be missing. For normal use, a frame buffer of 720x351 (or 724x351) is recommended (see below). Once the best settings have been found, they can be set in `ttl_in.h`, e.g.
   ...
   For precise adjustments of pixel clock and offset a higher system frequency (228 MHz) is needed, cf. [pico228MHz](https://github.com/rs1729/pico_ttl2vga/tree/pico228MHz) (no or minimal jitter on OAK067). It also helps converting to CGA palette. On ET3000 vmode detection sometimes fails, so checkout [pico228MHz_VpolCore1](https://github.com/rs1729/pico_ttl2vga/tree/pico228MHz_VpolCore1).<br />
